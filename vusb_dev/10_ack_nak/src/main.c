...
volatile uchar usbInputBufOffset;  /* offset in usbRxBuf used for low level receiving */
volatile uchar usbDeviceAddr = 0;
volatile uchar usbCurrentTok;      /* last token received or endpoint number for last OUT token if != 0 */
